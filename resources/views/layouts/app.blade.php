    ...
    <body class="font-sans antialiased bg-gray-50/50" x-data="{ sidebarOpen: false }">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="sidebar lg:translate-x-0">
            ...
            <nav class="flex-1 overflow-y-auto py-4 space-y-1">
                ...
                <span class="sidebar-link opacity-40 cursor-not-allowed" title="Bientôt disponible">
                    ...
                    Rapports <span class="text-xs text-gray-400">(bientôt)</span>
                </span>
                ...
                <a href="{{ route('admin.pricing-profiles.index') }}" class="sidebar-link {{ request()->is('admin/pricing-profiles*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.options.index') }}" class="sidebar-link {{ request()->is('admin/options*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.planning-events.index') }}" class="sidebar-link {{ request()->is('admin/planning-events*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/></svg>
                    Services & Evenements
                </a>

                <div class="sidebar-section">Ecosysteme</div>

                <a href="{{ route('admin.ecosystem.index') }}" class="sidebar-link {{ request()->is('admin/ecosystem*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    Partenaires
                </a>
