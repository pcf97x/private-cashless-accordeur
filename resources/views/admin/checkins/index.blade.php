...
<div class="max-w-7xl mx-auto">
    ...
    <div class="card p-6 mb-8">
        ...
        <form method="POST" action="{{ route('checkins.scan.weez') }}" id="scanForm" class="flex items-center gap-3">
            @csrf
            <input type="text" name="code" id="scanInput" class="form-input flex-1" placeholder="Scannez ou saisissez le code QR / Weezevent..." autofocus required>
            <button type="submit" class="btn-primary whitespace-nowrap">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                Pointer
            </button>
        </form>
        <p class="text-xs text-gray-400 mt-2">Scannez avec la douchette ou saisissez le code puis Entrée.</p>
    </div>
    ...
    (function() {
        ...
        // Re-focus le champ et scroll en haut après chargement
        input.focus();
        window.scrollTo(0, 0);
    })();
    </script>
